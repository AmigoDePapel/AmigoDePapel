namespace AmigoDePapel.CLASS.conSql
{
    ...
    {
        //public sql querys
        // SQL PUBICLOS - PARA CRIAÇÃO, CARREGAMENTO, VALIDAÇÃO E PREENCHIMENTO.
        //########################## CREATE TABLES ###########################
        //STK_ITEM_LIVRO
        ...
        //########################## GRID SELECT ###########################
        //STK_ITEM_LIVRO
        public string sql_select_stk_item_livro = @"SELECT 
                                                            ID, 
                                                            TITULO, 
                                                            SUBTITULO, 
                                                            ISBN, 
        ...
        //CRM_CLIENTE
        public string sql_select_crm_cliente = @"SELECT 
                                                        ID,
                                                        NOME, 
                                                        ENDERECO, 
                                                        DOCUMENTO, 
        ...
        // 
        //########################## CARREGA CADASTROS ###########################
        public string sql_selectCadastro_user = @"SELECT 
                                                        ID,
                                                        NOME,
                                                        NASCIMENTO,
                                                        ENDERECO,
                                                ...
                                                WHERE ISDELETED = 0 
                                                    AND ID = ";
        // 
        //########################## CARREGA PESQUISAS GRID ###########################
        public string sql_select_stk_item_livro_pesquisa = @"SELECT 
                                                            ID, 
                                                            TITULO, 
                                                            SUBTITULO, 
                                                            ISBN, 
